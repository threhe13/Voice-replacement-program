...
#font_fname = 'tacotron//utils//NanumBarunGothic.ttf'
...
from tacotron.text import PAD, EOS
from tacotron.utils import add_postfix
from tacotron.text.korean import normalize
...
def plot_spectrogram(pred_spectrogram, path, title=None, split_title=False, target_spectrogram=None, max_len=None, auto_aspect=False):
    ...
    if auto_aspect:
        ...
        plt.imshow(np.rot90(pred_spectrogram))
    else:
