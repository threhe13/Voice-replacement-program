...
from tacotron.tacotron2 import create_model, get_most_recent_checkpoint
from tacotron.utils.audio import save_wav, inv_linear_spectrogram, inv_preemphasis, inv_spectrogram_tensorflow
from tacotron.utils import plot, PARAMS_NAME, load_json, load_hparams, add_prefix, add_postfix, get_time, parallel_run, makedirs, str2bool

from tacotron.text.korean import tokenize
from tacotron.text import text_to_sequence, sequence_to_text
from tacotron.datasets.datafeeder_tacotron2 import _prepare_inputs
import warnings
...
def plot_graph_and_save_audio(
    ...
    if base_path:
        plot_path = "{}/{}.png".format(base_path, name)
    elif path:
    ...
    if plot_path:
        plot.plot_alignment(alignment, plot_path, text=text, isKorean=isKorean) #attention 이미지 저장
...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_path', default="logdir-tacotron2/kss")
