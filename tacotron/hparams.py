...
hparams = tf.contrib.training.HParams(
    ...
    hop_size=256,  # frame_shift_ms = 12.5ms # 300
    fft_size=1024,  # n_fft. 주로 1024로 되어있는데, tacotron에서 2048사용
    win_size=1024,  # 50ms
    num_mels=80,
...
if hparams.use_lws:
    ...
    hparams.fft_size = 1024  # 주로 1024로 되어있는데, tacotron에서 2048사용==> output size = 1025
